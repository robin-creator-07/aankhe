...
export function SiteFooter({ onStart }: SiteFooterProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col items-start gap-3 text-sm text-ankahe-muted">
              <button
                onClick={() => onStart && onStart("me")}
                className="hover:text-ankahe-text transition-colors cursor-pointer text-left"
              >
                Me Manual
              </button>
              <button
                onClick={() => onStart && onStart("work")}
                className="hover:text-ankahe-text transition-colors cursor-pointer text-left"
              >
                Work Manual
              </button>
              <span className="text-ankahe-muted/50 cursor-not-allowed">
